...
class OrganismoPublico(models.Model):
    """
    Representa al organismo público responsable de registrar y reportar us medidas
    correspondientes.
    """
...
class Medida(models.Model):
    """
    Representa una medida que debe ser ingresada y reportada por un organismo público y 
    para una comuna en específico. 
    ...
    comunas = models.ForeignKey(ComunaPlan, null=True, blank=True, on_delete=models.CASCADE)
